  ...
  switch (resolveType(propertyDef)) {
    ...
    case 'object':
      if (typeof value === 'object') {
        if (Array.isArray(propertyDef.anyOf)) {
          for (const schema of propertyDef.anyOf) {
            const result = castWithSchema(value, schema);
        ...
        return castWithSchema(value, propertyDef);
      }
      return undefined;
    default:
      return value;
